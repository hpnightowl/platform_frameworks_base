...
public class LockPatternUtils {
     ...
     **/
    public static final String KEY_PIN_LENGTH = "pin_password_length";
    ...
    public int getPinPasswordLength(int userId) {
        ...
        try {
            mPinPasswordLength = (int) getLockSettings().getLong(KEY_PIN_LENGTH, -1,
                    userId);
        } catch (Exception e) {
    ...
    public void setPinPasswordLength(int length, int userId) {
        try {
            getLockSettings().setLong(KEY_PIN_LENGTH, (long) length, userId);
        } catch (Exception e) {
